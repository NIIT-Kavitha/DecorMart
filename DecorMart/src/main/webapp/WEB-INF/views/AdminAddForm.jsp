    ...
    <div class="login-signup">
      <div class="row">
        ...
        <ul class="nav nav-tabs row" role="tablist">
          <li role="presentation" class="active col-sm-6"><a href="#product" aria-controls="product" role="tab" data-toggle="tab">Product</a></li>
          <li role="presentation" class="col-sm-6"><a href="#category" aria-controls="category" role="tab" data-toggle="tab">Category</a></li>
          <li role="presentation" class="col-sm-6"><a href="#supplier" aria-controls="supplier" role="tab" data-toggle="tab">Supplier</a></li>
        </ul>
      </div>
            ...
            <div class="col-sm-12 mobile-pull">
              <article role="login">
                ...
                <form class="signup" action="${addProduct}" method="post">
                  ...
                  <div class="form-group">
                    <input type="textarea" class="form-control" name="pdesc" placeholder="Product Decription">
                  </div>
                  <div class="form-group">
                    <input type="text" class="form-control" name="price" placeholder="Product Price">
                  </div>
                  <div class="form-group">
                    <input type="text" class="form-control" name="stock" placeholder="Product In Stock">
                  </div>
                  <div class="form-group">
